                    ...
                    try {
                        ...
                        try {
                            ...
                            for (int i = 0; i < count; i++) {
                                ...
                                if(jObject.getString("source").equalsIgnoreCase("") || jObject.getString("source").equalsIgnoreCase("null") || jObject.getString("source").isEmpty()){
                                    needIdentifierListAsString += "Web#";
                                }

                                else{
                                    switch(jObject.getString("source").toLowerCase()){
